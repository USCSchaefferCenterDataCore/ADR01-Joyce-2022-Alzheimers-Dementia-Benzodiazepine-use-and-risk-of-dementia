...
%doyrs(2017,2019,typlist=&types_wpde,ntypes=&ntyp_wpde,typchar=&typstr_wpde); * running on the annual file;
%doyrs(2020,2020,libq=q,typlist=&types_med,ntypes=&ntyp_med,typchar=&typstr_med); * running quarterly all the way to the end;
